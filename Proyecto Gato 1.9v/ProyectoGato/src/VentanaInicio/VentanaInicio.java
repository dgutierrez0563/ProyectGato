...
//                {jButton6,jButton4,jButton5},{jButton9,jButton7,jButton8}}; //Se declaran los indices del Arreglo con los JButton      
    ...
    //Boton para guardar datos de la partida
    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
        // TODO add your handling code here:
        guardarPartida();
    }//GEN-LAST:event_jMenuItem7ActionPerformed
    //Boton para lllamar a la clase ContactSupport
    ...
    //Boton para llamar a la clase AboutGato
...
//        }
    ...
    public void guardarPartida(){
        ...
        buckUp=false;
        botones[0][0]=jButton1.getText();
        botones[1][0]=jButton2.getText();
        botones[2][0]=jButton3.getText();
        botones[0][1]=jButton4.getText();
        botones[1][1]=jButton5.getText();
        botones[2][1]=jButton6.getText();
        botones[0][2]=jButton7.getText();
        botones[1][2]=jButton8.getText();
        botones[2][2]=jButton9.getText();
        buckUp=true;
    }
    ...
    public void reiniciarJuego(){
        if(buckUp==true){
            ...
            String opcion=(JOptionPane.showInputDialog(null,"no se han guardado los datos de la partida\ndesea guardar los datos?\nYes / No".toUpperCase(),"Mensaje del Sistema",JOptionPane.QUESTION_MESSAGE));
            do{
    ...
    public void registroJugadores(){  
        ...
        if((!"".equals(auxiliarNombre1))&&(!"".equals(auxiliarNombre2))){   //Validacion del registro de jugadores en el sistema
            count++;    //Contador
            instanciaConexion.registroJugadores(count,auxiliarNombre1);   //Inscripcion el jugador 1
            count++;    //Contador
            instanciaConexion.insertar(count,auxiliarNombre2);   //Inscripcion el jugador 1                     
