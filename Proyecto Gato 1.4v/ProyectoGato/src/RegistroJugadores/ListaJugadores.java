...
public class ListaJugadores {
    ...
    public void insertar(String nombre){
        if(!esVacia()){ //Validacion
            ultimo.siguiente=new RegistroJugadoresNodo(nombre); //creacion del nodo 
            ultimo=ultimo.siguiente;    //Enlace del nodo siguiente
        }else{  
            primero=ultimo=new RegistroJugadoresNodo(nombre);   //Creacion del nodo
        }
    }
    /**
